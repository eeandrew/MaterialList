 ...
 * {@link PhotoFrameResizeFragmentOld.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PhotoFrameResizeFragmentOld#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PhotoFrameResizeFragmentOld extends Fragment {
    ...
    public static PhotoFrameResizeFragmentOld newInstance(String photoUrl, String param2) {
        PhotoFrameResizeFragmentOld fragment = new PhotoFrameResizeFragmentOld();
    ...
    public PhotoFrameResizeFragmentOld() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View photoFrameResizeLayout = inflater.inflate(R.layout.fragment_photo_frame_resize_old, container, false);
        ...
        public boolean onTouch(View view, MotionEvent event) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_MOVE:
                    ...
                    centerX = oldX;//(int)photoResizeCenterMask.getX();
                    centerY = oldY;
                    centerWidth = oldWidth;
                    centerHeight = oldHeight;
                    ...
                    updatePhotoResizeMaskPositions((int)centerX, (int)centerY, (int)centerWidth, (int)centerHeight);
                    break;
                ...
                case MotionEvent.ACTION_DOWN:
                    originX = event.getRawX();
                    originY = event.getRawY();
                    oldX = photoResizeCenterMask.getX();
                    oldY = photoResizeCenterMask.getY();
                    oldWidth = photoResizeCenterMask.getWidth();
                    oldHeight = photoResizeCenterMask.getHeight();
                    switch (this.barType) {
                        case NORTH_BAR:
                            Log.d("PhotoFrameResizeFragmentOld", "PhotoResizeNorthBar Touched." + event.getRawY());
                            break;
                        case SOUTH_BAR:
                            Log.d("PhotoFrameResizeFragmentOld", "PhotoResizeSouthBar Touched.");
                            break;
                        case WEST_BAR:
                            Log.d("PhotoFrameResizeFragmentOld", "PhotoResizeWestBar Touched.");
                            break;
                        case EAST_BAR:
                            Log.d("PhotoFrameResizeFragmentOld", "PhotoResizeEastBar Touched.");
                            break;
                        default:
                            break;
