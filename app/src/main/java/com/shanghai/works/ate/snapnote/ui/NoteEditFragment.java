...
public class NoteEditFragment extends Fragment {
    ...
    private ImageButton noteSaveFab;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View noteDetailLayout = inflater.inflate(R.layout.fragment_note_edit, container, false);
        noteSaveFab = (ImageButton)noteDetailLayout.findViewById(R.id.note_save_fab);
        setUpClickListenerForNoteSaveFab(mParam1);
        return noteDetailLayout;
    }

    private void setUpClickListenerForNoteSaveFab(final String noteId){
        noteSaveFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.onNoteEditFragmentSaveFabClickInteraction(noteId);
            }
        });
    }
